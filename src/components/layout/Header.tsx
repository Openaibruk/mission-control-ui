...
import { Menu, Plus, FolderPlus, UserPlus, Bell, MessageSquarePlus } from 'lucide-react';
...
export function Header({ onMenuClick, onNewTask, onNewProject, onNewAgent, onOpenFeedback, theme, agents, tasks, pendingApprovals = 0 }: HeaderProps) {
