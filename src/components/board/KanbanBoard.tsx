...
import { AlertTriangle, Bell, ExternalLink, Download, FileText, ChevronRight, MoveRight, Filter, X } from 'lucide-react';
                        ...
                        <div onClick={e => e.stopPropagation()} className={cn("mb-1.5 p-2 rounded-md border", isDark ? "bg-emerald-500/5 border-emerald-500/20" : "bg-emerald-50 border-emerald-200")}>
                          ...
                          <div className="flex gap-1">
                            <a href={`/api/files?path=${encodeURIComponent(filePath)}&action=view`} target="_blank" rel="noopener noreferrer"
                              className="flex-1 flex items-center justify-center gap-1 text-[8px] bg-violet-600/20 text-violet-400 border border-violet-500/20 rounded px-1.5 py-0.5">
